...
Listens on one MQTT topic — {topic_prefix}/mac/{device_id}/voice_command
— and speaks whatever plain-text payload arrives, unretained, no
discovery needed (this is a command channel, not a state value with its
own HA entity).
"""
...
def main() -> None:
    ...
    def on_connect(client, userdata, flags, reason_code, properties=None):
        ...
        if rc != 0:
            ...
            return
        logger.info("Connected to MQTT. Subscribed to %s.", voice_topic)
